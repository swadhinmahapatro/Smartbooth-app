                ...
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="section-title position-relative mb-4 pb-2">
                            ...
                            <h2 class="mt-2">One step to digital India.</h2>
                        </div>
                        <p class="mb-4">With our smart card you can access your all of document. By our all in one QR you can manage your votes,your customization and many more. Just apply for a fresh smart card in your nearest SB center.</p>
                        <div class="row g-3">
                        </div>
                        <div class="d-flex align-items-center mt-4">
                            <a class="btn btn-primary rounded-pill px-4 me-3" href="">Locate Now</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    <div class="col-md-7 col-lg-4">
                        ...
                        <p><i class="fa fa-map-marker-alt me-3"></i>NIST,Palur Hills,Odisha</p>
                    ...
                    <div class="col-md-7 col-lg-4">
                        ...
                        <p>Get in touch with us by providing your mail</p>
