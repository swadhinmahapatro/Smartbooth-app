<?php
    ...
    function sendmail(){
        $name = "Smart-Booth";  // Name of your website or yours
        $to = "dashanirban275@gmail.com";  // mail of reciever
        $subject = "Tutorial or any subject";
        $body = "Send Mail Using PHPMailer - MS The Tech Guy";
        $from = "workwithanirbandash@gmail.com";  // you mail
        $password = "anirban@2000";  // your mail password
